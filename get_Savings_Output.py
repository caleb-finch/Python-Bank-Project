...
def get_Savings_Output(account_Info, username, function_Input, savingsAmnt, checkingsAmnt, transaction):
    if function_Input == 1:
        print(f'{username} deposited ${transaction} to their savings account. Their new balance:\nSavings Account: ${savingsAmnt}\nChecking Account: ${checkingsAmnt}')
    if function_Input == 2:
        print(f'{username} withdrew ${transaction} from their savings account. Their new balance:\nSavings Account: ${savingsAmnt}\nChecking Account: ${checkingsAmnt}')
    if function_Input == 3:
